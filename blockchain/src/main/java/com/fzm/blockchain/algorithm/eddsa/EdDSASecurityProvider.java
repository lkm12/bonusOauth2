...
public class EdDSASecurityProvider extends Provider {
    ...
    protected void setup() {
        ...
        put("KeyFactory." + EdDSAKey.KEY_ALGORITHM, "KeyFactory");
        put("KeyPairGenerator." + EdDSAKey.KEY_ALGORITHM, "KeyPairGenerator");
        put("Signature." + EdDSAEngine.SIGNATURE_ALGORITHM, "EdDSAEngine");
