package com.fuzamei.bonuspoint.entity.po.block;
...
@Table(name = "bp_block_info")
public class BlockInfoPO {

    public BlockInfoPO() {
    }

    public BlockInfoPO(Long uid, Long height, String hash, Long createdAt, Integer operationType) {
        this.uid = uid;
        this.height = height;
        this.hash = hash;
